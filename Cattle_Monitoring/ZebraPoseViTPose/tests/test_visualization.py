...
def test_imshow_keypoints():
    ...
    kpts = np.array([[1, 1, 1], [10, 10, 1]], dtype=float)
    pose_result = [kpts]
    skeleton = [[0, 1]]
    ...
    # 3D keypoint
    kpts_3d = np.array([[0, 0, 0, 1], [1, 1, 1, 1]], dtype=float)
...
def test_imshow_bbox():
    img = np.zeros((100, 100, 3), dtype=np.uint8)
    bboxes = np.array([[10, 10, 30, 30], [10, 50, 30, 80]], dtype=float)
...
def test_effects():
    img = np.zeros((100, 100, 3), dtype=np.uint8)
    kpts = np.array([[10., 10., 0.8], [20., 10., 0.8]], dtype=float)
